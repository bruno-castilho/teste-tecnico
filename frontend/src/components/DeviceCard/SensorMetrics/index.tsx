...
export function SensorMetics({devEui, TempC_SHT, Hum_SHT, Ext_TempC_SHT, Ext_Hum_SHT }: SensorMeticsProps){
    const [ openInternalTemperatureChartDialog, setOpenInternalTemperatureChartDialog] = useState(false)
    const [ openInternalHumidityChartDialog, setOpenInternalHumidityChartDialog] = useState(false)
    const [ openExternalTemperatureChartDialog, setOpenExternalTemperatureChartDialog] = useState(false)
    const [ openExternalHumidityChartDialog, setOpenExternalHumidityChartDialog] = useState(false)
    ...
    return <>
        ...
        <InternalTemperatureChart devEui={devEui} open={openInternalTemperatureChartDialog} onClose={handleInternalTemperatureChartDialog}/>
        <InternalHumidityChart devEui={devEui} open={openInternalHumidityChartDialog} onClose={handleInternalHumidityChartDialog}/>
        <ExternalTemperatureChart devEui={devEui} open={openExternalTemperatureChartDialog} onClose={handleExternalTemperatureChartDialog}/>
        <ExternalHumidityChart devEui={devEui} open={openExternalHumidityChartDialog} onClose={handleExternalHumidityChartDialog}/>
    </>
}